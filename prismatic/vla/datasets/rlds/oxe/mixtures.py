...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    "lerobot_single_smart_grab_fruit_avoid_poke_0707_rlds": [
        ("lerobot_single_smart_grab_fruit_avoid_poke_0707_rlds", 1.0),
    ],
    "lerobot_single_smart_grab_fruit_0710_rlds": [
        ("lerobot_single_smart_grab_fruit_0710_rlds", 1.0),
    ],
    "lerobot_single_smart_grab_fruit_0715_rlds": [
        ("lerobot_single_smart_grab_fruit_0715_rlds", 1.0),
    ],
    "lerobot_single_smart_grab_fruit_pi0_611s_rlds": [
        ("lerobot_single_smart_grab_fruit_pi0_611s_rlds", 1.0),
    ],
    "lerobot_single_clean_dish_pi0_0620_rlds": [
        ("lerobot_single_clean_dish_pi0_0620_rlds", 1.0),
    ],
    "lerobot_single_106_smart_grab_fruit_0916_rlds": [
        ("lerobot_single_106_smart_grab_fruit_0916_rlds", 1.0),
    ],
    "lerobot_single_106_grab_block_0928_rlds": [
        ("lerobot_single_106_grab_block_0928_rlds", 1.0),
    ],
    "lerobot_single_jq_grab_block_1015_rlds": [
        ("lerobot_single_jq_grab_block_1015_rlds", 1.0),
    ],
    "lerobot_single_jq_smart_grab_fruit_1016_rlds": [
        ("lerobot_single_jq_smart_grab_fruit_1016_rlds", 1.0),
    ],
    "lerobot_single_put_green_apple_in_green_plate_1019_rlds": [
        ("lerobot_single_put_green_apple_in_green_plate_1019_rlds", 1.0),
    ],
    "lerobot_single_put_red_apple_in_green_plate_1019_rlds": [
        ("lerobot_single_put_red_apple_in_green_plate_1019_rlds", 1.0),
    ],
    "lerobot_single_one_red_apple_1021_rlds": [
        ("lerobot_single_one_red_apple_1021_rlds", 1.0),
    ],
    ...
    "lerobot_dual_fold_0825_rlds": [
        ("lerobot_dual_fold_0825_rlds", 1.0),
    ],
    "lerobot_dual_fold_clothes_3_step_20250904_rlds": [
        ("lerobot_dual_fold_clothes_3_step_20250904_rlds", 1.0),
    ],
    "lerobot_dual_tasks": [
        ("lerobot_dual_fold_0825_rlds", 1.0),
        ("lerobot_dual_fold_clothes_3_step_20250904_rlds", 1.0),
    ...
    "lerobot_single_eef_106_smart_grab_fruit_0920_rlds": [
        ("lerobot_single_eef_106_smart_grab_fruit_0920_rlds", 1.0),
    ],
# fmt: on
}
